...
FROM [dbo].[Ordenes]
;
-- 10 registros únicos en la tabla órdenes
...
ORDER BY Empleados
;
--Hay 1 empelado en Cafetería, Cocina, Logística, Mantenimiento, Restaurante y Servicio, y 2 en Ventas y Administración.
...
; 
--Hay 2 productos de las categorías 1, 2, 4, 7 y 10
--OTRA FORMA DE HACERLO, PARA OBTENER EL NOMBRE DE LA CATEGORÍA
SELECT 
	COUNT(ProductoID) AS Productos, 
	C.[Nombre]
...
GROUP BY C.Nombre
;
--Hay 2 productos de las Categorías Comida Rápida, Ensaladas, Helados, Pizzas y Postres. 
...
/*Pregunta 5: ¿Cuáles son las sucursales con un promedio de Facturación/Ingresos 
...
;
--Las sucursales 9, 1, 7, 8 y 2 son las que poseen un promedio de Facturación/Ingresos > 1000 y minimizan sus costos en base a los Km recorridos, ordenados de menor a mayor. 
...
ORDER BY PromedioKmRecorridos
;
/*Las sucursales Lago, Central, Montaña, Valle y Norte son las que poseen un promedio de Facturación/Ingresos > 1000 y minimizan sus costos en base a los Km recorridos, 
